...
if __name__ == '__main__':
    ...
    train_features = extract_features_sequential(model, data_loader_train, multiscale=args.multiscale)
    query_features = extract_features_sequential(model, data_loader_query, multiscale=args.multiscale)
